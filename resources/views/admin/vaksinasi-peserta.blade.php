                  ...
                  <div class="card">
                    ...
                    <div class="card-body pd-0 table-responsive">
                      <table id="example1" class="table table-borderless mg-0">
                        ...
                        <tbody>
                          <tr>
                            <td class="td-its tx-medium align-middle border-bottom">05111740000002</td>
                            <td class="td-its tx-medium align-middle border-bottom">Bintang</td>
                            <td class="td-its align-middle border-bottom"><a href="#" class="btn btn-white btn-icon" role="button" data-toggle="modal" data-target="#hapusdpt" data-animation="effect-scale"><i data-feather="trash" class="wd-10"></i></a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <tr>
                    <td class="td-its tx-medium align-middle border-bottom">
                      <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="user1">05111740000002</label>
                      </div>
                    </td>
                    <td class="td-its tx-medium align-middle border-bottom">Bintang</td>
                  </tr>
